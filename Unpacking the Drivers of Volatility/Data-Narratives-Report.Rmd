...
\noindent You can find the R Markdown (RMD) file and the associated datasets in the 
...
findings. By employing a linear regression approach, the study strived to establish
...
\noindent By the end, the study shed light on the impact of external factors on the 
volatility of a company's stock price. The results demonstrated that inflation, 
interest rate, and unemployment are clear factors that affect the volatility of 
the stock price through rigorous analytical techniques (shown on the right). 
The analysis also suggested that the country's GDP, the company's 
debt-to-equity ratio, and price-to-earnings ratio are additional factors that 
could impact the stock price volatility (further research is necessary to confirm
this). Although the study tested a variety of factors, there may be other unexplored
...
unpredictable. The study provides valuable insights into potential drivers
...
influence on volatility. While the formulas changed with the addition of the 
inflation external factor, where previously significant coefficients may no longer 
be significant when the coefficient of the external regressor becomes significant, 
...
complexity of financial markets. Overall, although the linear relationship may 
not be visually apparent, the results of the linear regression test provided 
sufficient evidence to depict the presence of a linear relationship, which only
enforced the claim made before using the GARCH model surrounding the negative 
relationship between inflation and Apple stock volatility. 
\
\
...
\noindent The results demonstrated the coefficient estimate for the 
unemployment rate variable was 2.963e-05, and the p-value associated with
the coefficient was very small (< 2.2e-16). Therefore, the model provided 
...
\noindent The coefficient estimate for the interest rate variable was 2.394e-05, 
and the p-value associated with the coefficient was very small 
(7.697e-10). Thus, the model provided evidence for a positive 
